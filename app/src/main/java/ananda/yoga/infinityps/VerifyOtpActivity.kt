...
import ananda.yoga.infinityps.databinding.ActivityVerifyOtpBinding
...
class VerifyOtpActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Ambil email dari Intent (dikirim dari RegisterActivity)
    ...
    private fun doResend() {
        ...
        lifecycleScope.launch {
            try {
                val response = RetrofitClient.apiService.resendOtp(
    ...
    private fun startCountdown() {
        // Disable tombol resend selama countdown
